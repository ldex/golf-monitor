    ...
    <div class="golf-list-container">
      <div class="controls">
        ...
        <div class="checkbox-filter">
          <label>
            <input type="checkbox" (change)="toggleHideUndetermined()" [checked]="hideUndetermined()">
      ...
      <div class="golfs-grid">
        <div *ngIf="displayedGolfs().length === 0" class="no-golfs">
          <p>{{ isLoading() ? 'Chargement...' : 'Aucun golf trouvé' }}</p>
        </div>

        <div *ngFor="let golf of displayedGolfs()" class="golf-card">
          ...
          <div class="golf-body">
            ...
            <div class="coordinates" *ngIf="golf.coordinates">
